...
public class GoalData {
    ...
    public static String strava_id = "4374448"; // Fill in strava user id
    public static String auth_key =  "fc0ba552e721166043781871e7dcdabc45fd7826"; // Fill in api key from strava
